...
| Power menu | [wlogout](https://github.com/ArtsyMacaw/wlogout) — `~/.config/wlogout/` (Lock, Logout, Reboot, Suspend, Shutdown) |
...
| Lock on lid close | systemd user service — `~/.config/systemd/user/lid-lock.service` |
...
| `SUPER + Shift + P` | Меню питания (wlogout) |
| `SUPER + Shift + S` | Suspend с блокировкой экрана |
